  ...
  return (
    <div className="w-full animate-fade-in">
      <div className="text-center mb-6 sm:mb-10">
        ...
        <p className="text-sm sm:text-base text-gray-500">{t('inputQuestionSub', lang)}</p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
          <div>
            ...
            <textarea
              ...
              className="w-full min-h-[120px] sm:min-h-[180px] bg-white/[0.03] border border-white/[0.08] rounded-xl px-4 sm:px-6 py-4 sm:py-5 text-gray-200 placeholder-gray-600 focus:outline-none focus:border-purple-500/40 focus:ring-1 focus:ring-purple-500/20 transition-all resize-none text-sm sm:text-base leading-relaxed"
              disabled={isLoading}
            />
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6">
            <div className="flex gap-2 sm:gap-3">
              <button
                ...
                className={`px-4 sm:px-5 py-2 rounded-lg text-xs sm:text-sm font-medium transition-all duration-300 border ${
                  style === 'gentle'
            ...
            <button
              ...
              className={`w-full sm:w-auto px-6 sm:px-8 py-2.5 rounded-lg text-sm font-medium transition-all duration-300 ${
